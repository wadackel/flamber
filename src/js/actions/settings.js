...
// Update itemsLayout
export const UPDATE_ITEMS_LAYOUT_REQUEST = "UPDATE_BOARDS_LAYOUT_REQUEST";
export const UPDATE_ITEMS_LAYOUT_SUCCESS = "UPDATE_BOARDS_LAYOUT_SUCCESS";
export const UPDATE_ITEMS_LAYOUT_FAILURE = "UPDATE_BOARDS_LAYOUT_FAILURE";
