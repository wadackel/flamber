...
// Fetch settings
export const FETCH_SETTINGS_REQUEST: string = "FETCH_SETTINGS_REQUEST";
export const FETCH_SETTINGS_SUCCESS: string = "FETCH_SETTINGS_SUCCESS";
export const FETCH_SETTINGS_FAILURE: string = "FETCH_SETTINGS_FAILURE";
...
// Update theme
export const UPDATE_THEME_REQUEST: string = "UPDATE_THEME_REQUEST";
export const UPDATE_THEME_SUCCESS: string = "UPDATE_THEME_SUCCESS";
export const UPDATE_THEME_FAILURE: string = "UPDATE_THEME_FAILURE";
...
// Update boardsLayout
export const UPDATE_BOARDS_LAYOUT_REQUEST: string = "UPDATE_BOARDS_LAYOUT_REQUEST";
export const UPDATE_BOARDS_LAYOUT_SUCCESS: string = "UPDATE_BOARDS_LAYOUT_SUCCESS";
export const UPDATE_BOARDS_LAYOUT_FAILURE: string = "UPDATE_BOARDS_LAYOUT_FAILURE";
...
// Update itemsLayout
export const UPDATE_ITEMS_LAYOUT_REQUEST: string = "UPDATE_ITEMS_LAYOUT_REQUEST";
export const UPDATE_ITEMS_LAYOUT_SUCCESS: string = "UPDATE_ITEMS_LAYOUT_SUCCESS";
export const UPDATE_ITEMS_LAYOUT_FAILURE: string = "UPDATE_ITEMS_LAYOUT_FAILURE";
...
// Update itemsSize
export const UPDATE_ITEMS_SIZE_REQUEST_DEBOUNCE: string = "UPDATE_ITEMS_SIZE_REQUEST_DEBOUNCE";
export const UPDATE_ITEMS_SIZE_REQUEST: string = "UPDATE_ITEMS_SIZE_REQUEST";
export const UPDATE_ITEMS_SIZE_SUCCESS: string = "UPDATE_ITEMS_SIZE_SUCCESS";
export const UPDATE_ITEMS_SIZE_FAILURE: string = "UPDATE_ITEMS_SIZE_FAILURE";
...
// Update itemsOrderBy
export const UPDATE_ITEMS_ORDER_BY_REQUEST: string = "UPDATE_ITEMS_ORDER_BY_REQUEST";
export const UPDATE_ITEMS_ORDER_BY_SUCCESS: string = "UPDATE_ITEMS_ORDER_BY_SUCCESS";
export const UPDATE_ITEMS_ORDER_BY_FAILURE: string = "UPDATE_ITEMS_ORDER_BY_FAILURE";
...
// Update itemsOrder
export const UPDATE_ITEMS_ORDER_REQUEST: string = "UPDATE_ITEMS_ORDER_REQUEST";
export const UPDATE_ITEMS_ORDER_SUCCESS: string = "UPDATE_ITEMS_ORDER_SUCCESS";
export const UPDATE_ITEMS_ORDER_FAILURE: string = "UPDATE_ITEMS_ORDER_FAILURE";
...
export const UPDATE_BOARDS_ORDER_BY_REQUEST: string = "UPDATE_BOARDS_ORDER_BY_REQUEST";
export const UPDATE_BOARDS_ORDER_BY_SUCCESS: string = "UPDATE_BOARDS_ORDER_BY_SUCCESS";
export const UPDATE_BOARDS_ORDER_BY_FAILURE: string = "UPDATE_BOARDS_ORDER_BY_FAILURE";
...
// Update boardsOrder
export const UPDATE_BOARDS_ORDER_REQUEST: string = "UPDATE_BOARDS_ORDER_REQUEST";
export const UPDATE_BOARDS_ORDER_SUCCESS: string = "UPDATE_BOARDS_ORDER_SUCCESS";
export const UPDATE_BOARDS_ORDER_FAILURE: string = "UPDATE_BOARDS_ORDER_FAILURE";
